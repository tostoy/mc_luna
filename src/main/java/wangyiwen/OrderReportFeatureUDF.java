...
@Resolve({"string,string,string,string,string,string,string,string->string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string," +
        ...
        "string,string, string, string, string, string, string, string, string,string,string,string,string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string, string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string,string"})
...
public class OrderReportFeatureUDF extends UDTF {
    ...
    public void process(Object[] args) throws UDFException {
        ...
        feature[769],feature[772],feature[773],feature[774],feature[775],feature[776],feature[777],feature[778],feature[779],feature[780],feature[781],feature[782],feature[783],feature[785],feature[786],feature[787],feature[788],feature[789],feature[790],feature[791],feature[792],feature[793],feature[794],feature[795],feature[796],feature[797],feature[798],feature[799],feature[800],feature[801],feature[802],feature[803],feature[804],feature[805],feature[806],feature[807],feature[808],feature[809],feature[810],feature[811],feature[812],feature[813],feature[814],feature[815],feature[816],feature[817],feature[818],feature[819],feature[820],feature[821],feature[822],feature[823],feature[824],feature[825],feature[826],feature[827],feature[828],feature[830],feature[831],feature[832],feature[833],feature[834],feature[835],feature[837],feature[838],feature[839],feature[840],feature[841],feature[842],feature[843],feature[844],feature[845],feature[846],feature[16],feature[17],feature[18],
                ...
                feature[938], feature[939], feature[940], feature[941], feature[942], feature[943], feature[944], feature[945], feature[946], feature[947], feature[948],feature[8], feature[13], feature[37], feature[38], feature[42], feature[43], feature[259], feature[713], feature[741], feature[743], feature[746], feature[760], feature[910], feature[962], feature[982], feature[986], feature[988], feature[989], feature[990], feature[991], feature[992], feature[995], feature[1002], feature[1003], feature[1004], feature[1005], feature[1006], feature[1007], feature[1008], feature[1012], feature[1013], feature[1014], feature[1015], feature[1020], feature[1021], feature[1022], feature[1023], feature[1024], feature[1025], feature[1026], feature[1027], feature[1028], feature[1029], feature[1030], feature[1032], feature[1033], feature[1034], feature[1035], feature[1036], feature[1037], feature[1038], feature[1039], feature[1040], feature[1041], feature[1042], feature[1043], feature[1047],
                feature[1055],feature[1056],feature[1057],feature[1058],
                args[7]);
    }
